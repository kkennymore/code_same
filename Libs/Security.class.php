...
abstract class Security
{
    ...
    public static function adminBefore()
    {
        if (!Session::get('adm_email')) {
            return UrlRequestFunctions::pageRedirect(DS . Config::get('ADMIN') . '/login/');
        }
        return true;
    }
    ...
    public static function userBefore()
    {
        if (!Session::get('email')) {
            return UrlRequestFunctions::pageRedirect('/users/login/');
        }
        return true;
    }
    ...
    {
        if (Session::get('adm_email')) {
            return UrlRequestFunctions::pageRedirect(DS  . Config::get('ADMIN') . '/index/');
        }
        return false;
    }
    ...
    {
        if (Session::get('email')) {
            return UrlRequestFunctions::pageRedirect('/dashboard/home/');
        }
        return false;
    }
